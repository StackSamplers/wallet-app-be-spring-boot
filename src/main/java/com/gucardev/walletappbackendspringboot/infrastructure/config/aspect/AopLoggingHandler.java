package com.gucardev.walletappbackendspringboot.infrastructure.config.aspect;
...
public class AopLoggingHandler {
    ...
    private static final String BASE_PACKAGE = "com.gucardev.walletappbackendspringboot";
